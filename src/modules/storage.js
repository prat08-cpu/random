...
function initStorage() {
    // Try to get data (user-scoped)
    projectsHandler.items = JSON.parse(localStorage.getItem(getUserStorageKey("projects")));
    tasksHandler.items = JSON.parse(localStorage.getItem(getUserStorageKey("tasks")));
    ...
    localStorage.setItem(getUserStorageKey("projects"), JSON.stringify(testProjectsData));
    localStorage.setItem(getUserStorageKey("tasks"), JSON.stringify(testTasksData));
...
function updateProjectsStorage() {
    localStorage.setItem(getUserStorageKey("projects"), JSON.stringify(projectsHandler.items));
}

function updateTasksStorage() {
    localStorage.setItem(getUserStorageKey("tasks"), JSON.stringify(tasksHandler.items));
}
